...
# from main import get_result, get_result_for_new_schema
...
# @pytest.mark.repeat(STRESS_TEST_REPEAT_COUNT)
# def test_with_new_schema(db_migrations, db_data, benchmark):
#     db_conn = db_migrations(settings.MIGRATION_INITIAL)
#     with closing(db_conn) as conn:
#         db_data(conn, 'exchange_rates', Factory.exchange_rates(10))
#         assert benchmark(get_result_for_new_schema, conn) == 2
